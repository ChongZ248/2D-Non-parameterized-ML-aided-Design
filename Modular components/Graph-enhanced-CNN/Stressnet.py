...
class Modfiedunet4shrinknopad(nn.Module): ###https://doi.org/10.1016/j.mechmat.2021.104191
...
class Modfiedunet4shrink(nn.Module): ###https://doi.org/10.1016/j.mechmat.2021.104191
    def __init__(self,chin=6,k=16,chlist=[8,32,64,128,128,128,128,128,64,32,9]):
        super().__init__()
        self.c1=Block1(chin=chin,chout=k)
        self.c2=Block2(chin=k,chout=k)
        self.c22=Block2(chin=2*k,chout=2*k)
        self.c23=Block2(chin=4*k,chout=4*k)
        self.c3=Block3(chin=8*k,chout=8*k)
...
class Modfiedunet_CMAME(nn.Module): ###https://doi.org/10.1016/j.mechmat.2021.104191
    def __init__(self,chin=6,chlist=[8,32,64,128,128,128,128,128,64,32,9]):
        super().__init__()
        self.c1=Block1(chin=chin,chout=k)
        self.c2=Block2(chin=k,chout=k)
        self.c3=Block3(chin=2*k,chout=2*k)
...
class Modfiedunet3shrink_CMAME(nn.Module): ###https://doi.org/10.1016/j.mechmat.2021.104191
    def __init__(self,chin=6,k=8,chlist=[5,32,64,128,128,128,128,128,64,32,1]):
        super().__init__()
        self.c1=Block1(chin=chin,chout=k)
        self.c2=Block2(chin=k,chout=k)
        self.c22=Block2(chin=2*k,chout=2*k)
